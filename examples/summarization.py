...
from seq2seq.models import DecoderRNN, EncoderRNN, Seq2seq
...
# Sample usage:
#     # training
#     python examples/sample.py --train_path $TRAIN_PATH
#            --dev_path $DEV_PATH --expt_dir $EXPT_PATH
#     # resuming from the latest checkpoint of the experiment
#     python examples/sample.py --train_path $TRAIN_PATH
#            --dev_path $DEV_PATH --expt_dir $EXPT_PATH --resume
